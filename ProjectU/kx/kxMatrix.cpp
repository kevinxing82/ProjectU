...
//                         |  3  7 11 15 |
//
// Dependencies: Vector2, kxVector3, kxVector3
//
...
///////////////////////////////////////////////////////////////////////////////
float kxMatrix2::getDeterminant() const
{
...
// angle = atan(s / c)
///////////////////////////////////////////////////////////////////////////////
float kxMatrix2::getAngle() const
{
...
///////////////////////////////////////////////////////////////////////////////
float kxMatrix3::getDeterminant() const
{
...
///////////////////////////////////////////////////////////////////////////////
kxVector3 kxMatrix3::getAngle() const
{
...
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::invertEuclidean()
{
...
//  [ 0 | 1 ]     [  0   +     1     ]
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::invertAffine()
{
	// R^-1
	kxMatrix3 r(m[0], m[1], m[2], m[4], m[5], m[6], m[8], m[9], m[10]);
	r.invert();
...
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::invertProjective()
{
	// partition
	kxMatrix2 a(m[0], m[1], m[4], m[5]);
	kxMatrix2 b(m[8], m[9], m[12], m[13]);
	kxMatrix2 c(m[2], m[3], m[6], m[7]);
	kxMatrix2 d(m[10], m[11], m[14], m[15]);

	// pre-compute repeated parts
	a.invert();             // A^-1
	kxMatrix2 ab = a * b;     // A^-1 * B
	kxMatrix2 ca = c * a;     // C * A^-1
	kxMatrix2 cab = ca * b;   // C * A^-1 * B
	kxMatrix2 dcab = d - cab; // D - C * A^-1 * B
	...
	// compute D' and -D'
	kxMatrix2 d1 = dcab;      //  (D - C * A^-1 * B)
	d1.invert();            //  (D - C * A^-1 * B)^-1
	kxMatrix2 d2 = -d1;       // -(D - C * A^-1 * B)^-1

							// compute C'
	kxMatrix2 c1 = d2 * ca;   // -D' * (C * A^-1)

							// compute B'
	kxMatrix2 b1 = ab * d2;   // (A^-1 * B) * -D'

							// compute A'
	kxMatrix2 a1 = a - (ab * c1); // A^-1 - (A^-1 * B) * C'
...
// M^-1 = adj(M) / det(M)
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::invertGeneral()
{
...
///////////////////////////////////////////////////////////////////////////////
float kxMatrix4::getDeterminant() const
{
...
///////////////////////////////////////////////////////////////////////////////
float kxMatrix4::getCofactor(float m0, float m1, float m2,
...
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::translate(const kxVector3& v)
{
	return translate(v.x, v.y, v.z);
}

kxMatrix4& kxMatrix4::translate(float x, float y, float z)
{
...
// uniform scale
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::scale(float s)
{
	return scale(s, s, s);
}

kxMatrix4& kxMatrix4::scale(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::rotate(float angle, const kxVector3& axis)
{
	return rotate(angle, axis.x, axis.y, axis.z);
}

kxMatrix4& kxMatrix4::rotate(float angle, float x, float y, float z)
{
...
kxMatrix4& kxMatrix4::rotateX(float angle)
{
...
kxMatrix4& kxMatrix4::rotateY(float angle)
{
	float c = cosf(angle * DEG2RAD);
	float s = sinf(angle * DEG2RAD);
	float m0 = m[0], m2 = m[2],
...
kxMatrix4& kxMatrix4::rotateZ(float angle)
{
	float c = cosf(angle * DEG2RAD);
	float s = sinf(angle * DEG2RAD);
	float m0 = m[0], m1 = m[1],
...
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::lookAt(const kxVector3& target)
{
...
kxMatrix4& kxMatrix4::lookAt(const kxVector3& target, const kxVector3& upVec)
{
	// compute forward vector and normalize
	kxVector3 position = kxVector3(m[12], m[13], m[14]);
	kxVector3 forward = target - position;
	...
	// compute left vector
	kxVector3 left = upVec.cross(forward);
	left.normalize();
...
kxMatrix4& kxMatrix4::lookAt(float tx, float ty, float tz)
{
	return lookAt(kxVector3(tx, ty, tz));
}

kxMatrix4& kxMatrix4::lookAt(float tx, float ty, float tz, float ux, float uy, float uz)
{
...
///////////////////////////////////////////////////////////////////////////////
kxMatrix3 kxMatrix4::getRotationMatrix() const
{
	kxMatrix3 mat(m[0], m[1], m[2],
		m[4], m[5], m[6],
		m[8], m[9], m[10]);
	return mat;
}
...
///////////////////////////////////////////////////////////////////////////////
kxMatrix4& kxMatrix4::skew(float angle, const kxVector3& axis)
{
...
///////////////////////////////////////////////////////////////////////////////
kxVector3 kxMatrix4::getAngle() const
{
	float pitch, yaw, roll;         // 3 angles
